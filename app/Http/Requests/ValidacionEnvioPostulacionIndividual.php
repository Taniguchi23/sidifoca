...
class ValidacionEnvioPostulacionIndividual extends FormRequest
{
    /**
    ...
    {
        return [
            'url_declaracion_representante' => ['required', 'file', 'mimes:pdf,jpeg,bmp,png', 'max:2048'],
            'url_declaracion_equipo' => ['required', 'file', 'mimes:pdf,jpeg,bmp,png', 'max:2048'],
