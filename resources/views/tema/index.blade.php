...
<div class="container">
    ...
    <div class="botonera">
        @show ('crear_tema')
        <button type="button" class="btn btn-primary btn-lg pop-up" data-url="{{ route('tema.crear') }}">Nuevo registro</button>
        @endshow
    </div>
    {{ Form::open(['route' => 'tema', 'autocomplete' => 'off', 'id' => 'busqueda']) }}
    {{ Form::hidden('page', 1) }}
    <fieldset class="custom">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('tema') }}" class="btn btn-default btn-lg margen" title="Reiniciar"><i class="fa fa-refresh"></i></a>
            </div>
        </div>
    </fieldset>
    {{ Form::close() }}
...
<script type="text/template" id="template">
    @show ('editar_tema')
    <button type="button" data-url="{{ route('tema') }}/editar/@id" class="btn btn-primary pop-up" title="Editar"><i class="fa fa-edit"></i></button>
    @endshow
    <button type="button" data-url="{{ route('tema') }}/detalles/@id" class="btn btn-default pop-up" title="Detalles"><i class="fa fa-eye"></i></button>
</script>
@endsection
