...
<div class="container">
    ...
    <div class="botonera">
        @show ('crear_provincia')
        <button type="button" class="btn btn-primary btn-lg pop-up" data-url="{{ route('provincia.crear') }}">Nuevo registro</button>
        @endshow
    </div>
    {{ Form::open(['route' => 'provincia', 'autocomplete' => 'off', 'id' => 'busqueda']) }}
    {{ Form::hidden('page', 1) }}
    <fieldset class="custom">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('provincia') }}" class="btn btn-default btn-lg margen" title="Reiniciar"><i class="fa fa-refresh"></i></a>
            </div>
        </div>
    </fieldset>
    {{ Form::close() }}
...
<script type="text/template" id="template">
    @show ('editar_provincia')
    <button type="button" data-url="{{ route('provincia') }}/editar/@id" class="btn btn-primary pop-up" title="Editar"><i class="fa fa-edit"></i></button>
    @endshow
    <button type="button" data-url="{{ route('provincia') }}/detalles/@id" class="btn btn-default pop-up" title="Detalles"><i class="fa fa-eye"></i></button>
</script>
@endsection
