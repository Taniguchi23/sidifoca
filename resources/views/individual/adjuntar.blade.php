        ...
        <div class="panel-body">
            <div id="rootwizard">
                <ul class="nav nav-pills nav-justified thumbnail">
                    ...
                    <li>
                        <a href="{{ route('individual.editar', $postulacion->id_postulacion) }}">
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        {{ Form::model($postulacion, ['route' => ['individual.enviar', $postulacion->id_postulacion], 'autocomplete' => 'off', 'files' => true, 'id' => 'editar']) }}
                        {{ Form::divError() }}
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-control-static">{{ $postulacion->buena_practica }}</div>
                                    </div>
                                </div>
                                <div class="form-group form-group-lg">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-md-7">
                                        {{ Form::fileinput('url_declaracion_representante', ['accept' => 'image/jpeg,image/gif,image/png,application/pdf,image/x-eps']) }}
                                ...
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-md-7">
                                        {{ Form::fileinput('url_declaracion_equipo', ['accept' => 'image/jpeg,image/gif,image/png,application/pdf,image/x-eps']) }}
                                        <span class="text-primary">Documento formato PDF o Imagen | Peso máx. 2MB</span>
                                    </div>
                                    <div class="col-md-1">
            ...
            $.ajax({
                ...
                success: function(json) {
                    if (!json.success) {
                        ...
                        $.redirect("{{ route('individual.adjuntar', $postulacion->id_postulacion) }}");
                    }
                },
