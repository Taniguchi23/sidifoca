...
<div class="container">
    ...
    <ol class="breadcrumb">
        <li>
            <a href="{{ route('postulacion') }}"><strong>Admisión</strong></a>
        </li>
        <li class="active">Validar</li>
    </ol>
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Validar postulación</h3>
        </div>
        <div class="panel-body">
            {{ Form::model($postulacion, ['route' => ['postulacion.grabar', $postulacion->id_postulacion], 'autocomplete' => 'off', 'id' => 'editar']) }}
            <div class="form-horizontal">
                <div class="form-group form-group-lg">
                    {{ Form::label('estado', 'Ficha de admisión', ['class' => 'asterisk control-label col-md-3']) }}
                    <div class="col-md-9">
                        <div class="radio">
                            <label class="radio-inline">
                                {{ Form::radio('estado', true, 1) }} Completo (Siguiente fase)
                            </label>
                            <label class="radio-inline">
                                {{ Form::radio('estado', 2) }} Corregir postulación
                            </label>
                            <label class="radio-inline">
                                {{ Form::radio('estado', 3) }} Rechazar postulación
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group form-group-lg">
                    {{ Form::label('observacion', 'Comentarios', ['class' => 'asterisk control-label col-md-3']) }}
                    <div class="col-md-9">
                        {{ Form::textarea('observacion', null, ['class' => 'form-control', 'cols' => '30', 'rows' => '8', 'maxlength' => '1000']) }}
                    </div>
                </div>
        ...
        <div class="panel-body">
            ...
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group form-group-lg">
                        {{ Form::label(null, 'Gobierno regional', ['class' => 'control-label col-md-3']) }}
                        <div class="col-md-9">
                            <p class="form-control-static">{{ $postulacion->gobierno_regional->descripcion }}</p>
                        </div>
                    </div>
                    <div class="form-group form-group-lg">
            ...
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group form-group-lg">
                        {{ Form::label(null, 'Teléfonos', ['class' => 'control-label col-md-3']) }}
                        <div class="col-md-9">
                            <p class="form-control-static">
                                {{ $postulacion->contacto_postulacion->telefono_fijo }}
                                @isset($postulacion->contacto_postulacion->telefono_celular)
                                /
                                @endempty
                                {{ $postulacion->contacto_postulacion->telefono_celular }}
                            </p>
                        </div>
                    </div>
                    <div class="form-group form-group-lg">
                ...
                <table class="table table-bordered table-hover tabla">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $director->nombres }} {{ $director->apellido_paterno }} {{ $director->apellido_materno }}</td>
                            <td>
                                <ul>
                                    ...
                                    <li>{{ $equipo_postulacion->nombres }} {{ $equipo_postulacion->apellido_paterno }} {{ $equipo_postulacion->apellido_materno }}</li>
                                    @endif
                                    @endforeach
                                </ul>
                            </td>
            ...
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static">
                                <a href="{{ route('postulacion.acta_modalidad_colectiva', $postulacion->id_postulacion) }}" class="btn btn-primary btn-lg">Descargar</a>
                            </p>
                        </div>
                    </div>
                    <div class="form-group form-group-lg">
