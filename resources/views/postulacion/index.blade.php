...
<div class="container">
    ...
    {{ Form::open(['route' => 'postulacion', 'autocomplete' => 'off', 'id' => 'busqueda']) }}
    {{ Form::hidden('page', 1) }}
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-lg">
                            {{ Form::label('id_concurso', 'Concurso') }}
                            {{ Form::select('id_concurso', Arr::pluck($arr_concurso, 'descripcion', 'id_concurso'), null, ['placeholder' => '- Seleccione su Concurso -', 'class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group form-group-lg">
                    ...
                    {{ Form::text('buena_practica', null, ['placeholder' => 'Buena Práctica', 'class' => 'form-control description', 'maxlength' => 255]) }}
                </div>
            </div>
            <div class="col-md-3">
...
<script type="text/template" id="template">
    <a href="{{ route('postulacion') }}/detalles/@id" class="btn btn-default" title="Detalles"><i class="fa fa-eye"></i></a>
</script>
@endsection
...
<script nonce="{{ request()->nonce }}">
    ...
    $(function() {
        $("#id_modalidad").change(function(e) {
            var self = this;
            $.ajax({
                url: "{{ route('postulacion.listar_tipo_postulacion') }}",
                data: {
        ...
        $("#id_categoria").change(function(e) {
            var self = this;
            $.ajax({
                url: "{{ route('postulacion.listar_tema') }}",
                data: {
        ...
        grid = $("#grid").grid({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    title: "Concurso",
                    renderer: function(value, record) {
                        return $.exec(record.concurso, function(ref) {
                ...
                },
                {
                    ...
                    width: 80,
                    renderer: function(value, record) {
                        return $.exec(record.postulacion_admitida, function(ref) {
                            return ref.puntaje_total;
                        });
                    }
                },
                {
                    ...
                    renderer: function(value, record) {
                        if (value) {
                            return '<i class="fa fa-trophy" title="Ganador"></i>';
                        }
                        return '<i class="fa fa-window-close" title="No Ganador"></i>';
                    }
                },
                {
                    field: "flg_estado",
