...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            {{ Form::model($postulacion, ['route' => ['admision.grabar', $postulacion->id_postulacion], 'autocomplete' => 'off', 'id' => 'editar']) }}
            <div class="form-horizontal">
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-md-9">
                        {{ Form::textarea('observacion', null, ['class' => 'form-control description', 'cols' => '30', 'rows' => '8', 'maxlength' => '1000']) }}
                    </div>
                </div>
            ...
            <div class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static">
                                <a href="{{ route('admision.acta_modalidad_colectiva', $postulacion->id_postulacion) }}" class="btn btn-primary btn-lg" target="_blank">Descargar</a>
                            </p>
                        </div>
                    </div>
                    <div class="form-group form-group-lg">
                ...
                $.ajax({
                    ...
                    success: function(json) {
                        if (!json.success) {
                            ...
                            var radioValue = $("input[name='estado']:checked").val();
                            var mensaje = "La operación se completó con éxito";

                            if (radioValue == 1) mensaje = "<p>La ficha de postulación " + json.data.codigo + " ha sido enviada a la Fase II</p>";
                            if (radioValue == 2) mensaje = "<p>La ficha de postulación " + json.data.codigo + "  debe ser corregida por el postulante.</p>";
                            if (radioValue == 3) mensaje = "<p>La ficha de postulación " + json.data.codigo + " ha sido rechazada.</p>";

                            bootbox.alert({
                                closeButton: false,
                                title: "Fase I - Admision",
                                message: mensaje,
                                buttons: {
                                    ok: {
                                        label: "CONTINUAR",
