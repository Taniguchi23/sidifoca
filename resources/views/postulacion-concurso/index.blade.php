...
<div class="container">
    <div class="page-header">
        <h1>Fase de admisión de postulaciones</h1>
    </div>
    {{ Form::open(['route' => 'admision', 'autocomplete' => 'off', 'id' => 'busqueda']) }}
    {{ Form::hidden('page', 1) }}
    <fieldset class="custom">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('admision') }}" class="btn btn-default btn-lg margen" title="Reiniciar"><i class="fa fa-refresh"></i></a>
            </div>
        </div>
    </fieldset>
    {{ Form::close() }}
...
<script type="text/template" id="template">
    @show ('validar_postulacion')
    <a href="{{ route('admision') }}/validar/@id" class="btn btn-primary" title="Validar"><i class="fa fa-check"></i></a>
    @endshow
    <a href="{{ route('admision') }}/detalles/@id" class="btn btn-default" title="Detalles"><i class="fa fa-eye"></i></a>
</script>
@endsection
...
<script nonce="{{ request()->nonce }}">
    ...
    $(function() {
        $("#id_modalidad").change(function(e) {
            var self = this;
            $.ajax({
                url: "{{ route('admision.listar_tipo_postulacion') }}",
                data: {
        ...
        $("#id_categoria").change(function(e) {
            var self = this;
            $.ajax({
                url: "{{ route('admision.listar_tema') }}",
                data: {
