...
<div class="container">
    ...
    {{ Form::model($perfil, ['route' => ['perfil.grabar', $perfil->id_perfil], 'autocomplete' => 'off', 'id' => 'editar']) }}
    {{ Form::divError() }}
    <fieldset>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group form-group-lg">
                {{ Form::label(null, 'Estado', ['class' => 'control-label col-md-3 asterisk']) }}
                <div class="col-md-9">
                    <div class="radio">
    ...
    <fieldset>
        ...
        <div class="row widget-header-div">
            ...
            <div class="col-md-4 widget-header-item">
                ...
                <div class="checkbox">
                    <label>
                        {{ Form::checkbox('id_permiso[]', $permiso->id_permiso, $perfil->arr_perfil_permiso->contains('id_permiso', $permiso->id_permiso)) }} {{ $permiso->descripcion }}
                    </label>
                </div>
                @endforeach
            </div>
    ...
    <fieldset>
        ...
        <h4>
            <label>
                {{ Form::checkbox('id_menu[]', $parent->id_menu, $perfil->arr_perfil_menu->contains('id_menu', $parent->id_menu), ['class' => 'menu']) }} {{ $parent->descripcion }}
            </label>
        </h4>
        @foreach($parent->children as $menu)
        <div class="checkbox sub-menu">
            <label>
                {{ Form::checkbox('id_menu[]', $menu->id_menu, $perfil->arr_perfil_menu->contains('id_menu', $menu->id_menu), ['class' => 'sub-menu', 'data-parent' => $parent->id_menu]) }} {{ $menu->descripcion }}
            </label>
        </div>
        @endforeach
        @endforeach
