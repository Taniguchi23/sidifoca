...
<body>
    ...
    <section>
        ...
        <p>El representante de la buena práctica, Director(a) {{ $director->nombres }} {{ $director->apellido_paterno }} {{ $director->apellido_materno }}, declara formalmente que:</p>
        <ol>
            <li>Conoce las bases del concurso y acepta lo establecido en ellas y las decisiones del Jurado Calificador.</li>
            <li>Acredita que la práctica postulada fue diseñada y/o implementada de manera conjunta con la DRE/GRE o UGEL que representa la postulación.</li>
        ...
        <div style="text-align: center; margin-top: 100px;">
            ...
            <strong>{{ $director->nombres }} {{ $director->apellido_paterno }} {{ $director->apellido_materno }}</strong>
            <br>
            Director(a) de la Unidad de Gestión Educativa Local de {{ $director->ugel }}
            <br>
            <strong>DNI: {{ $director->nro_dni }}</strong>
        </div>
    </section>
    @if (!$loop->last)
