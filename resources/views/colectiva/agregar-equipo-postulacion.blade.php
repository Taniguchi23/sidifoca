{{ Form::open(['route' => ['colectiva.guardar_equipo_postulacion', $id_postulacion], 'autocomplete' => 'off', 'id' => 'grabar']) }}
{{ Form::hidden('p_id_director', $id_director) }}
            ...
            $.ajax({
                ...
                success: function(json) {
                    if (!json.success) {
                        ...
                        $("#accordion").accordion({
                            url: "{{ route('colectiva.listar_director', $id_postulacion) }}"
                        });
