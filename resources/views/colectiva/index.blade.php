                    ...
                    <div class="row widget-header-div">
                        <div class="col-md-4 widget-header-item">
                            <div class="jumbotron text-center">
                                ...
                                <button type="submit" data-url="{{ route('colectiva.registrar') }}" class="btn btn-primary btn-block btn-lg" id="nuevo">INGRESAR</button>
                            </div>
                        </div>
                        <div class="col-md-4 widget-header-item">
                            <div class="jumbotron text-center">
                                ...
                                <button type="button" data-url="{{ route('colectiva.codigo') }}" class="btn btn-primary btn-block btn-lg" id="editar">INGRESAR</button>
                            </div>
                        </div>
                        <div class="col-md-4 widget-header-item">
                            <div class="jumbotron text-center">
                                ...
                                <button type="button" data-url="{{ route('colectiva.codigo') }}" class="btn btn-primary btn-block btn-lg" id="adjuntar">INGRESAR</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                success: function(json) {
                    if (!json.success) {
                        ...
                        bootbox.alert({
                            ...
                            callback: function() {
                                $.blockUI();
                                $.redirect("{{ route('colectiva') }}/editar/@id", {
                            ...
                            $.ajax({
                                ...
                                success: function(json) {
                                    if (!json.success) {
                                        ...
                                        $.blockUI();
                                        $.redirect("{{ route('colectiva') }}/adjuntar/@id", {
                                            id: json.data.id_postulacion
                                        });
                                    }
                                    $.unblockUI();
