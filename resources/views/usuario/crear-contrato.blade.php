    ...
    <div id="rootwizard">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                {{ Form::open(['route' => ['usuario.guardar_contrato'], 'files' => 'true', 'autocomplete' => 'off', 'id' => 'editar']) }}
                ...
                <fieldset class="redondeado">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="checkbox">
                                <label>
                                    {{ Form::checkbox('flg_ejerce_cargo', 1, true) }} ¿Ejerce actualmente el cargo?
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(json) {
                    if (!json.success) {
                        ...
                        $.redirect("{{ route('usuario.detalles', $usuario->id_usuario) }}");
                    }
                },
