{{ Form::model($criterio, ['route' => ['criterio.grabar', $criterio->id_criterio], 'autocomplete' => 'off', 'files' => true, 'id' => 'editar']) }}
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group form-group-lg">
                {{ Form::label('id_modalidad', 'Modalidad', ['class' => 'asterisk']) }}
            ...
            <div class="form-group form-group-lg">
                {{ Form::label('detalles', 'Detalles', ['class' => 'asterisk']) }}
                {{ Form::textarea('detalles', null, ['class' => 'form-control', 'cols' => '30', 'rows' => '6', 'maxlength' => '1000']) }}
            </div>
            <div class="form-group form-group-lg">
                {{ Form::label('puntaje_maximo', 'Puntaje máximo', ['class' => 'asterisk']) }}
                {{ Form::text('puntaje_maximo', null, ['placeholder' => 'Puntaje máximo', 'class' => 'form-control', 'maxlength' => '255']) }}
            </div>
            <div class="form-group form-group-lg">
